...
describe('<Layout /> component', () => {
    ...
    it('should render a div with className .layout and child div with className .Layout__body', () => {
        ...
        expect(layout.find('.Layout .Layout__body').length).toBe(1);
    });

    it('should render a connected <Header /> component with className .Layout__header', () => {
    ...
    it('should render a <Footer /> component with className .Layout__footer', () => {
        expect(layout.find('Footer').length).toBe(1);
        expect(layout.find('Footer').props().className).toContain('Layout__footer');
    });
});
